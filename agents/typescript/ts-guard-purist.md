...
description: Audits type guards, exhaustive switch checks, discriminated union handling, and never assertions. Triggers on "type guards", "exhaustive checks", "discriminated unions", "ts guard purist".
