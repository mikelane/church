...
description: Finds type assertions, @ts-ignore directives, non-null assertions, and unsafe casts. Triggers on "type assertions", "as casts", "ts-ignore", "ts-expect-error", "ts assertion purist".
