...
description: Audits correlation ID propagation, endpoint instrumentation, and distributed tracing completeness. Triggers on "tracing audit", "correlation IDs", "distributed tracing", "tracing purist".
