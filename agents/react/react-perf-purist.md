...
description: Audits memoization patterns, unstable references, missing React.memo, and useTransition for heavy updates. Triggers on "react performance", "memoization", "re-render audit", "react perf purist".
