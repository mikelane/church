...
description: Audits server/client state boundaries, Cache Hack and Syncing Store violations, and Computed Derivation. Triggers on "state management", "great separation", "optimistic UI", "react state purist".
