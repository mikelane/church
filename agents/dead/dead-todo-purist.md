...
description: Finds TODO, FIXME, HACK, and XXX comments and checks their age via git blame. Triggers on "stale TODOs", "FIXME audit", "TODO cleanup", "dead todo purist".
