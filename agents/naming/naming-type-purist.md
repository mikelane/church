...
description: Audits PascalCase types, past-tense events, and eliminates Hungarian notation on interfaces and enums. Triggers on "type naming", "event naming", "interface naming", "naming type purist".
