...
**Specialist agents in this crusade (e.g. `kotlin-coroutine-purist`) are NOT registered with Claude Code.** They live on disk in `specialists/` and are loaded on demand — never at startup.
