...
description: Enforces boolean prefixes, bans generic names, and eliminates single-letter variables. Triggers on "variable naming", "boolean prefixes", "generic names", "naming variable purist".
