...
description: Audits cyclomatic complexity, function length, class size, and nesting depth. Triggers on "python complexity", "function too long", "god class", "nesting depth", "python complexity purist".
