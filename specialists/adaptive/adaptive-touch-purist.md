...
description: Audits touch target sizing (44x44px min), hover-only interactions, pointer events, and drag-and-drop feedback. Triggers on "touch targets", "hover dependency", "tap target", "adaptive touch purist".
