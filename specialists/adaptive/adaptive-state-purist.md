...
description: Audits state preservation during resize, fold, and rotate — scroll position, form drafts, viewport-dependent state. Triggers on "state preservation", "rotate state", "adaptive state purist".
