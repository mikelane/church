...
description: Detects schema-domain divergence, hardcoded enum subsets, and untyped Zustand selectors. Triggers on "schema alignment", "zod audit", "zustand types", "ts schema purist".
