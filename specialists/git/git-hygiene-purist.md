...
description: Finds missing .gitignore entries, poorly named branches, and tracked build artifacts. Triggers on "gitignore audit", "branch naming", "tracked artifacts", "git hygiene purist".
