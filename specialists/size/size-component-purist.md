...
description: Finds oversized .tsx files and plans Extract Component, Extract Hook, and Provider/Component splits. Triggers on "component size", "bloated component", "split component", "size component purist".
