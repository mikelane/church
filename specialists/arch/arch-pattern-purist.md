...
description: Audits repository pattern compliance, interface segregation, layer skipping, and type duplication. Triggers on "repository pattern", "interface segregation", "layer skipping", "arch pattern purist".
