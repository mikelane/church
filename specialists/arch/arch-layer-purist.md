...
description: Detects domain purity violations, upward dependencies, and layer boundary breaches. Triggers on "layer violations", "domain purity", "upward dependencies", "arch layer purist".
