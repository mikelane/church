...
description: Detects direct imports between domain modules and enforces event-driven communication. Triggers on "cross-domain imports", "domain isolation", "domain boundaries", "arch cross-domain purist".
