...
description: Searches entire git history for credentials ever committed and later removed. Triggers on "git history scan", "historical secrets", "committed credentials", "secret history purist".
