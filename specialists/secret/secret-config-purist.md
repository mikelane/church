...
description: Validates .gitignore coverage, .env placeholder hygiene, and CI/CD secret manager usage. Triggers on "config security", "gitignore audit", "env security", "CI secrets", "secret config purist".
