...
description: Audits button labels, error messages, tooltips, form fields, and empty states. Triggers on "button copy", "error messages", "UX copy", "UI text", "microcopy", "copy microcopy purist".
