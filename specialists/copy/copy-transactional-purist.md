...
description: Audits transactional emails and SMS for deliverability, no-reply addresses, and vague subjects. Triggers on "email copy", "SMS copy", "transactional", "copy transactional purist".
